...
`release/SSB-Setup-1.3.0.exe`. Generated files are ignored by Git.
...
```powershell
python tools/sign_release.py --key C:\secure\ssb-private.key --tool .tools/winsparkle/WinSparkle-0.9.4/bin/winsparkle-tool.exe --installer release/SSB-Setup-1.3.0.exe --version 1.3.0 --output release/appcast.xml
```
